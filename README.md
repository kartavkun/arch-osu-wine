...
```sh
curl -fsSL https://raw.githubusercontent.com/kartavkun/arch-osu-wine/proton-9.8/setup.sh | sh
```

If you need to update, you need to paste it

```sh
curl -fsSL https://raw.githubusercontent.com/kartavkun/arch-osu-wine/proton-9.8/update.sh | sh
```
